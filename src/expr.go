...
type Visitor interface {
	...
	visitCallExpr(call *Call) (interface{}, error)
	visitGetExpr(get *Get) (interface{}, error)
	...
	visitSetExpr(set *Set) (interface{}, error)
	visitSuperExpr(super *Super) (interface{}, error)
...
func (assign *Assign) Accept(visitor Visitor) (interface{}, error) {
...
func (binary *Binary) Accept(visitor Visitor) (interface{}, error) {
...
func (call *Call) Accept(visitor Visitor) (interface{}, error) {
...
func (get *Get) Accept(visitor Visitor) (interface{}, error) {
...
func (logical *Logical) Accept(visitor Visitor) (interface{}, error) {
...
func (set *Set) Accept(visitor Visitor) (interface{}, error) {
...
func (super *Super) Accept(visitor Visitor) (interface{}, error) {
...
func (this *This) Accept(visitor Visitor) (interface{}, error) {
...
func (variable *Variable) Accept(visitor Visitor) (interface{}, error) {
